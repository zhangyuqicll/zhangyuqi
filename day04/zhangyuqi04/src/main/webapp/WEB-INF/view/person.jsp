...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="companyId" id = "txt_search_roleid">
						<option value="0">---请选择---</option>
						<c:forEach items="${clist }" var="r">
						 	<option value="${r.companyId }">${r.companyName }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>所属公司：</td>
								<td colspan="4">
									<select class="form-control" name="companyId" id = "roleid" aria-required="true" required>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            companyId: $("#txt_search_roleid").val(),
	...
	function initEditUser(getSelection){
		...
		$('#roleid').val(getSelection.companyId);
