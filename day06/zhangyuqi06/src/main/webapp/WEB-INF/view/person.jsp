...
<body class="gray-bg">
				...
				<div class="input-group">
					...
					<select class="form-control" name="expressTypeId" id = "txt_search_roleid">
						...
						<c:forEach items="${clist }" var="r">
						 	<option value="${r.id }">${r.expressName }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>密码：</td>
								<td>
								<input type="radio" id="sex" name="sex" aria-required="true" required value="男"/>男
								<input type="radio" id="sex" name="sex" aria-required="true" required value="女"/>女
								</td>
							</tr>
							<tr>
								<td>人员特点：</td>
								...
								<input type="checkbox" id="expressTrait2" name="expressTrait" aria-required="true" required value="干练"/>干练
								<input type="checkbox" id="expressTrait3" name="expressTrait" aria-required="true" required value="效率"/>效率
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>入职时间：</td>
								<td>
								<input type="date" id="entryTime" name="entryTime" aria-required="true" required/>
							...
							<tr>
								...
								<td>创建时间：</td>
								<td>
								<input type="date" id="createTime" name="createTime" aria-required="true" required/>
	...
	<div class="modal fade" id="modal_user_ru" role="dialog" aria-labelledby="modal_user_ru" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
						<form action="ruPerson.htm" method="post" id="daoru" enctype="multipart/form-data">
   ...
   <!-- layerDate plugin javascript -->
	...
	function initEditUser(getSelection){
		...
		$('#expressTrait2').prop("checked",getSelection.expressTrait.indexOf("干练")!=-1);
		$('#expressTrait3').prop("checked",getSelection.expressTrait.indexOf("效率")!=-1);
