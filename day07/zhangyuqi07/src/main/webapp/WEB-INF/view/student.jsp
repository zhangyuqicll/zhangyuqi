        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">学生名称 </span>
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="did" id = "txt_search_roleid">
						<option value="0">---请选择---</option>
						<c:forEach items="${dlist }" var="r">
						 	<option value="${r.depid }">${r.dname }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm" enctype="multipart/form-data">
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                formatter:function(value,row,index){
	                	return '<img alt="" src="/img/'+value+'" width="50px" height="50px">';
	                }
	            }, {
	                field: 'createtime',
	                title: '入学时间',
