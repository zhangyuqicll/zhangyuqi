        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="depid" id = "txt_search_roleid">
					...
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生生日：</td>
								<td>
								<input type="date" id="birthday" name="birthday" aria-required="true" required/>
								</td>
							</tr>
							<tr>
							<td>学生年龄：</td>
							...
							<tr>
								<td>学校名称：</td>
								<td colspan="4">
									<select class="form-control" name="depid" id = "depid" aria-required="true" required>
