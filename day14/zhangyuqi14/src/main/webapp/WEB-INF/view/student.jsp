...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">代课老师</span>
					<select class="form-control" name="teacherid" id = "txt_search_roleid">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>入学时间：</td>
								<td> <input placeholder="开始时间" id="entrytime" name="entrytime" class="laydate-icon form-control layer-date"/></td>
								<td>&nbsp;&nbsp;</td>
								<td>创建时间：</td>
								<td> <input placeholder="开始时间" id="createtime" name="createtime" class="laydate-icon form-control layer-date"/></td>
							</tr>
							<tr>
								<td>学生名字：</td>
								<td>
	...
	<div class="modal fade" id="modal_user_type" role="dialog" aria-labelledby="modal_user_type" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_type" method="post" action="reserveType.htm">
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_echarts").click(function(){
	    			...
	    			$.ajax({
						...
						var ydata=new Array();
	    			    	if(res.success){
	    		    		res.elist.forEach(function(student){
	    		    			xdata.push(student.num);
	    		    			ydata.push({value:student.num,name:student.cname})
	    		    		})	
	    		    		option = {
    			    		    title: {
    			    		        text: '某站点用户访问来源',
