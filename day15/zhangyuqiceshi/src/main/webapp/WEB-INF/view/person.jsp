...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">存款银行</span>
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 <label class="col-sm-2 control-label">存款时间</label>
                 <div class="col-sm-8">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>人员性别：</td>
								<td>
								<input type="radio" id="pSex" name="pSex"aria-required="true" required value="男"/>男
								<input type="radio" id="pSex" name="pSex"aria-required="true" required value="女"/>女
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>人员爱好：</td>
								<td>
								<input type="checkbox" id="pLike1" name="pLike" aria-required="true" required value="豪车"/>豪车
								<input type="checkbox" id="pLike2" name="pLike" aria-required="true" required value="名表"/>名表
								<input type="checkbox" id="pLike3" name="pLike" aria-required="true" required value="美女"/>美女
								</td>
							</tr>
							<tr>
								<td>存款银行：</td>
	...
	<div class="modal fade" id="modal_type_edit" role="dialog" aria-labelledby="modal_type_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_type" method="post" action="reserveBank.htm">
	...
	<div class="modal fade" id="modal_user_ru" role="dialog" aria-labelledby="modal_user_ru" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<form action="ruPerson.htm" method="post" enctype="multipart/form-data" id="daoru">
							<input type="file" name="ru">
							</form>
				</div>
				<div class="modal-footer">
